# closed-loop eval workspace

Grades whether the [`closed-loop`](../../engineering/closed-loop/SKILL.md) skill's agents
...
cases/case1/prompt.txt the task, with the /closed-loop prefix
